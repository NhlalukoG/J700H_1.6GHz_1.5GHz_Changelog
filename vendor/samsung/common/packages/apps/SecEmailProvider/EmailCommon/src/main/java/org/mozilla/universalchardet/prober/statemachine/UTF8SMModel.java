...
public class UTF8SMModel extends SMModel {
    ...
    public UTF8SMModel() {
        super(new PkgInt(INDEX_SHIFT_4BITS, SHIFT_MASK_4BITS, BIT_SHIFT_4BITS, UNIT_MASK_4BITS,
                utf8ClassTable), UTF8_CLASS_FACTOR, new PkgInt(INDEX_SHIFT_4BITS, SHIFT_MASK_4BITS,
                BIT_SHIFT_4BITS, UNIT_MASK_4BITS, utf8StateTable), utf8CharLenTable,
    ...
    private static int[] utf8StateTable = new int[] {
            ...
            PkgInt.pack4bits(ERROR, ERROR, ERROR, ERROR, ERROR, ERROR, ERROR, ERROR)
    // c8-cf
    };
